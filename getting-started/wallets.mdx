---
title: Your Wallets
description: "Understanding your auto-created EVM and Solana wallets"
---
...
<CardGroup cols={2}>
  <Card title="EVM Wallet" icon="ethereum">
    Works on Ethereum, Base, Polygon, BSC, and Arbitrum. Used for Polymarket, Limitless, and token swaps.
  </Card>
...
- Private keys are **encrypted at rest** by Privy
- No seed phrases to manage
- Wallet operations are secured via Privy's embedded wallet infrastructure
